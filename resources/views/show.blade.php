        ...
        <div class="row">
          ...
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="{{asset('assets/img/artikel/'.$data->foto)}}"  alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">{{$data->judul}}</h2>
            <p>{!!$data->konten!!}</p>
            <p> <strong class="text-primary h4">Rp {{$data->harga}}</strong></p>
