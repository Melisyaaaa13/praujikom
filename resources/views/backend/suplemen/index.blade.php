      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="suplemen">
                  <span class="menu-title">suplemen</span>
                  <i class="mdi mdi-home menu-icon"></i>
                </a>
              </li>
          </ul>
          ...
          <div class="content-wrapper">
            <div class="row" id="proBanner">
                <div class="card-body">
                        <div class="card">
                            <div>
                    <h5 class="card-header">Data Tables Suplemen</h5><br>
                <center>
                    ...
                    <table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$data->harga}}</td>
                                <td>
                                    <form action="{{route('suplemen.destroy', $data->id)}}" method="post">
                                        {{csrf_field()}}
									<a href="{{route('suplemen.edit', $data->id)}}"
										class="zmdi zmdi-edit btn btn-warning btn-rounded btn-floating btn-outline"> Edit
                                    </a>
                                    <input type="hidden" name="_method" value="DELETE">
										<button type="submit" class="zmdi zmdi-delete btn-rounded btn-floating btn btn-dangerbtn btn-danger btn-outline"> Delete</button>
